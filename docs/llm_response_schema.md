...
| `industry_quality.score` | number | 行业质量得分，范围 [0, 6] |
| `industry_quality.max_score` | number | 固定 6.0 |
...
| `qualitative_max` | number | 固定 26.0 |
...
| `income_stability.score` | number | 收入稳定性得分，范围 [0, 5] |
| `income_stability.max_score` | number | 固定 5.0 |
| `income_stability.reason` | string | 评分理由 |
| `business_model_quality.score` | number | 商业模式质量得分，范围 [0, 5] |
| `business_model_quality.max_score` | number | 固定 5.0 |
...
| `total_score` | number | 三个维度得分 + 前置判断综合 |
| `max_total` | number | 固定 13.0 |
...
|------|------|------|
| `stock_code` | string | 股票代码 |
| `capital_allocation.score` | number | 资本配置能力得分，范围 [0, 6] |
| `capital_allocation.max_score` | number | 固定 6.0 |
